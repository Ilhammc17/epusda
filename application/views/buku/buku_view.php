	    ...
	    <div class="col-md-12">
	        <div class="box box-primary">
                <div class="box-header with-border">
					...
					<?php }?>
                    <span class="dropdown">
                        <button class="btn btn-success dropdown-toggle"  style="margin-top:0.5pc;"
                            type="button" data-toggle="dropdown"> Sortir Kategori 
                    ...
                    <span class="dropdown">
                        <button class="btn btn-danger dropdown-toggle"  style="margin-top:0.5pc;"  
                            type="button" data-toggle="dropdown"> Sortir Rak buku 
...
<script>
    ...
    $(document).ready(function() {
        tabel = $('#example').DataTable({
            ...
            {
                <?php if($this->input->get('sortir')){?>
                    "url": "<?= base_url('data/data_buku?sortir='.htmlspecialchars($this->input->get('sortir')));?>", // URL file untuk proses select datanya
                <?php }else{?>
                    <?php if($this->input->get('rak')){?>
                        "url": "<?= base_url('data/data_buku?rak='.htmlspecialchars($this->input->get('rak')));?>", 
                    <?php }else{?>
                        "url": "<?= base_url('data/data_buku');?>", 
                    <?php }?>
                <?php }?>
                "type": "POST"
            },
