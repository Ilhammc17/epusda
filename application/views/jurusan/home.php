					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('data/jurproses');?>">
								<div class="form-group">
								<label for="">Nama Status</label>
								    <input type="text" name="jurusan" id="jurusan" class="form-control" placeholder="Contoh : SD / SMP / SMA / Umum">
								</div>
								<br/>
								<input type="hidden" name="tambah" value="tambah">
								<button type="submit" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Status</button>
							</form>
							<?php }?>
						</div>
					</div>
