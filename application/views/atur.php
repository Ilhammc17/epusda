                        ...
                        <div class="box-body">
                            <form method="post" action="<?=base_url('dashboard/aturan');?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= $atur->nama_perpus;?>" class="form-control" name="nama_perpus" id="nama_perpus" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label for="">E-mail</label>
                                    <input type="email" value="<?= $atur->email;?>" class="form-control" name="email" id="email" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label for="">Telepon</label>
                                    <input type="number" value="<?= $atur->telepon;?>" class="form-control" name="telepon" id="telepon" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label for="">Alamat</label>
                                    <textarea class="form-control" name="alamat" id="alamat" placeholder=""><?= $atur->alamat;?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="">Logo</label>
                                    <input type="file" 
                                        class="form-control" accept="image/*" 
                                        name="logo" id="logo" placeholder="">
                                    <?php 
