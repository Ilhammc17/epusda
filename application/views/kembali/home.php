						...
						<table class="table table-striped table-bordered">
							...
							<td>
								...
								<?php if($this->session->userdata('level') == 'Petugas'){ ?>
									<?php if(!empty($this->input->get('cari'))){?>
										<a href="<?= base_url('transaksi');?>/excel.php?sortir=kembali&cari=yes&bln=<?=$this->input->get('bln');?>&thn=<?=$this->input->get('thn');?>" class="btn btn-info"><i class="fa fa-download"></i>
										Excel</a>
										<a href="<?= base_url('transaksi');?>/cetak?sortir=kembali&bln=<?=$this->input->get('bln');?>&thn=<?=$this->input->get('thn');?>" target="_blank" class="btn btn-warning btn-md"><i class="fa fa-print"></i> Print </a>
									<?php }else{?>
										<a href="<?= base_url('transaksi');?>/excel?sortir=kembali" class="btn btn-info"><i class="fa fa-download"></i>
										Excel</a>
										<a href="<?= base_url('transaksi');?>/cetak?sortir=kembali" target="_blank" class="btn btn-warning btn-md"><i class="fa fa-print"></i> Print </a>
									<?php }?>
								<?php }?>
							</td>
							</tr>
