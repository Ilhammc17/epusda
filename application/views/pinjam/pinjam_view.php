							...
							<td>
								...
								<?php if($this->session->userdata('level') == 'Petugas'){ ?>
									<?php if(!empty($this->input->get('bln'))){?>
										<a href="<?= base_url('transaksi');?>/excel?bln=<?=$this->input->get('bln');?>&thn=<?=$this->input->get('thn');?>" class="btn btn-info"><i class="fa fa-download"></i>
										Excel</a>
										<a href="<?= base_url('transaksi');?>/cetak?bln=<?=$this->input->get('bln');?>&thn=<?=$this->input->get('thn');?>" target="_blank" class="btn btn-warning btn-md"><i class="fa fa-print"></i> Print </a>
									<?php }else{?>
										<a href="<?= base_url('transaksi');?>/excel" class="btn btn-info"><i class="fa fa-download"></i>
										Excel</a>
										<a href="<?= base_url('transaksi');?>/cetak" target="_blank" class="btn btn-warning btn-md"><i class="fa fa-print"></i> Print </a>
									<?php }?>
								<?php }?>
							</td>
							</tr>
					...
					<center>
						<h4> - 
							<?php if(!empty($this->input->get('bln') && $this->input->get('thn'))){ ?>
								Data Peminjaman <?= $bulan_tes[$this->input->get('bln')];?> <?= $this->input->get('thn');?>
							<?php }else{?>
