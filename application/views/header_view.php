...
<?php $atur = $this->db->query("SELECT * FROM tbl_atur WHERE id = 1")->row();?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title><?php echo $title_web;?> | Sistem Informasi Perpustakaan Subang </title>
...
?>
<body class="hold-transition skin-green-light sidebar-mini <?= $class_side;?>">
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li>
            <?php
             ...
             ?>
            <a href="<?= base_url('user/edit/'.$uid);?>" class="bg-green">
